// ModelTest.c
// OpenGL SuperBible
// Demonstrates rendering a sample model
...
GLuint dlModel;          // Display list identifier for the model
...
int main(int argc, char* argv[])
	...
	glutCreateWindow("Loading a Simple Model");
