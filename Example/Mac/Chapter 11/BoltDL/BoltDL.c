// BoltDL.c
// OpenGL SuperBible
// Demonstrates rendering a bolt as sepearte pieces (Bolt Threads)
// But using display lists
...
// Rotation amounts - Arrow keys moves bolt around
...
void RenderThread(void)
	...
	GLTVector3 vNormal, vCorners[4];// Storeage for calculate normal and corners
...
void RenderShaft(void)
	...
	GLTVector3 vNormal,vCorners[2];     // Storeage for vertex calculations
...
void RenderHead(void)
    ...
    GLTVector3 vNormal,vCorners[4];    // Storeage of vertices and normals
